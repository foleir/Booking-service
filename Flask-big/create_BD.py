...
def create_tables():
    ...
    class Revievs(db.Model):
        ...
        object_id = db.Column(db.Integer, db.ForeignKey('equipment.object_id'), nullable=False)
        user_id = db.Column(db.Integer, db.ForeignKey('users.user_id'), nullable=False)
        reviev_text = db.Column(db.Text)
        __table_args__ = (db.UniqueConstraint('object_id', 'user_id', name='_object_user_uc'),)
    ...
    class BookHistory(db.Model):
        ...
        __table_args__ = (db.UniqueConstraint('object_id', 'user_id', 'room_id', 'data_book', name='_booking_uc'),)
    ...
    class Favorites(db.Model):
        ...
        object_id = db.Column(db.Integer, db.ForeignKey('equipment.object_id'), primary_key=True)
        user_id = db.Column(db.Integer, db.ForeignKey('users.user_id'), primary_key=True)
        __table_args__ = (db.UniqueConstraint('object_id', 'user_id', name='_favorite_uc'),)
