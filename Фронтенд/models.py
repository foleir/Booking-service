...
class Equipment(db.Model):
    ...
    object_gabaritType = db.Column(db.String(255), nullable=False)
    ...
    # favorited_by = db.relationship('Favorites', backref='equipment', lazy='dynamic', cascade='all, delete-orphan')
